...
// Create a modern favicon with a stylized "D" design
// Using a gradient circle with a "D" shape cut out
async function generateFavicon() {
 const sizes = [16, 32, 48, 64, 128, 256];
 const publicDir = path.join(__dirname, 'public');
 
 // Create SVG for the favicon - a modern "D" design with RODiT theme
 ...
 Q ${size*0.75} ${size*0.75} ${size*0.75} ${size*0.5}
 Q ${size*0.75} ${size*0.25} ${size*0.5} ${size*0.25}
 Z
 M ${size*0.4} ${size*0.35}
 L ${size*0.5} ${size*0.35}
 Q ${size*0.65} ${size*0.35} ${size*0.65} ${size*0.5}
 Q ${size*0.65} ${size*0.65} ${size*0.5} ${size*0.65}
